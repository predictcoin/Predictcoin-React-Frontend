...
const MatchPredictionModal: FC<MatchPredictionModalProps> = ({closeModal}) => {
    ...
    <div id='match__prediction__modal'>
        <div className='match__prediction__modal__content'>
          ...
          <div className='modal__head'>
            ...
            <p>You will be charged 10 CRO for each pool entered and earn x10 (100 CRO) when you win.</p>

            <div className='modal__body'>
              <div className='team__details'>
                <div className='team__one'>
                  <img src = "/assets/img/manchester_united_logo.png" alt = "team two logo"/>
                  <p>MAN</p>
                </div>
                  <GoDash className='seperator' />
                <div className='team__two'>
                  <img src = "/assets/img/napoli_logo.png" alt = "team one logo"/>
                  <p>MAN</p>
                </div>
              </div>
              <form className='predict__form'>
                <div className='inputs__container'>
                  <label htmlFor='team__one'>
                    <input type="number" name="team__one" />
                  </label>
                  <p className='text'>Predict the scores (1-100)</p>
                  <label htmlFor='team__two'>
                    <input type="number" name="team__two" />
                  </label>
                </div>
