...
const FarmingCard: FC<FarmingCardModel> = ({
	...
	switch(tokenName) {
		case "BUSD-PRED LP":
			imgSrc = "/assets/img/busdpred.png"
			break;
		case "BNB-PRED LP":
			imgSrc = "/assets/img/bnbpred.png"
			break;
		case "USDT-PRED LP":
			imgSrc = "/assets/img/usdtpred.png"
			break;
		default:
			break;
	}
		...
		<div className='farming__card'>
			<div className='farming__card__top'>
				<div className='token__images'>
					<img src={imgSrc} className = "farm_pool_img" alt='liquidity provider token logo' />
				</div>
			...
			<div className='farming__card__content'>
				<div className='price__stake'>
					...
					</div>
					{
						active && 
						<div className="card-row">
							<div><span className="light">EARNED</span><span>{displayTokenValue(earned, 18, 5)} PRED</span></div>
